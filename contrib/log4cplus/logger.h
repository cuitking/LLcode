...
namespace log4cplus
{
	...
	public:
		...
		void Log(const Logger& l, const log4cplus::tstring& _msg,
...
#pragma warning( disable : 4996 )
			logger.forcedLog(TRACE_LOG_LEVEL, log4cplus::tstring("ENTER: ") + _itoa(line, szLine, 10) + "," + funtcion + "," + msg, file, line);
#pragma warning( pop )
		}
...
#pragma warning( push )
#pragma warning( disable : 4996 )
				logger.forcedLog(TRACE_LOG_LEVEL, log4cplus::tstring("EXIT : ") + _itoa(line, szLine, 10) + "," + funtcion + "," + msg, file, line);
#pragma warning( pop )
			}
		}
