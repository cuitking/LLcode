...
public:
	...
	inline ThrowingPolicy GetTossPolicy(void) const
	{
		return m_policy;
	}

	inline void SetTossPolicy(ThrowingPolicy policy)
	{
		m_policy = policy;
	}
...
public:
	...
	inline static TestResults* GetIt(void)
	{
		return s_instance;
	}
...
public:
	...
	static volatile Thing& GetIt(void)
	{
		return *s_thing;
	}
	...
	unsigned int GetValue(void) const volatile
	{
		return m_value;
	}
	...
	inline volatile SleepMutex& GetMutex(void) volatile
	{
		return m_mutex;
	}
...
public:
	...
	inline unsigned int GetValue(void) const volatile
	{
		return m_value;
	}
