...
namespace mongo
{
	...
	namespace dur
	{
		...
		public:
			...
			*/
			...
			inline int& writingInt(const int& d)
			{
				return *((int*) writingPtr((int*) &d, sizeof(d)));
			}
	...
	inline DiskLoc& DiskLoc::writing() const
	{
		return getDur().writingDiskLoc(*const_cast< DiskLoc* >(this));
	}
