...
namespace mongo
{
	...
	struct ByLocKey
	{
		...
		{
			return ByLocKey(l , numeric_limits<long long>::min());
		}
		static ByLocKey max(const DiskLoc& l)
		{
			return ByLocKey(l , numeric_limits<long long>::max());
		}
	...
	*/
	...
	public:
		...
		*/
		...
		void incPos(int n)
		{
			_pos += n;    // TODO: this is bad
		}
		void setPos(int n)
		{
			_pos = n;    // TODO : this is bad too
		}
		...
		{
			return _c->modifiedKeys();
		}
		bool isMultiKey() const
		{
			return _c->isMultiKey();
		}
		...
		*/
		...
		bool currentIsDup()
		{
			return _c->getsetdup(_c->currLoc());
		}
		...
		void setChunkManager(ShardChunkManagerPtr manager)
		{
			_chunkManager = manager;
		}
		ShardChunkManagerPtr getChunkManager()
		{
