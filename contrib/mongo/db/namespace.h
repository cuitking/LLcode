...
namespace mongo
{
	...
	*/
	...
	public:
		...
		NamespaceString(const char* ns)
		{
			init(ns);
		}
		NamespaceString(const string& ns)
		{
			init(ns.c_str());
		}
		string ns() const
...
#pragma pack(1)
	...
	*/
	...
	{
	public:
		explicit Namespace(const char* ns)
		{
			*this = ns;
		}
	...
	*/
	...
	public:
		...
		*/
		...
		{
			return nIndexes + indexBuildInProgress;
		}
		...
		*/
		...
		public:
			int pos()
			{
				return i;    // note this is the next one to come
			}
			bool more()
			{
				return i < n;
