...
namespace mongo
{
	...
	*/
	...
	public:
		...
		Projection* getFields() const
		{
			return _fields.get();
		}
		shared_ptr<Projection> getFieldPtr() const
		{
			return _fields;
		}
		...
		const BSONObj& getOrder() const
		{
			return _order;
		}
		const BSONElement& getHint() const
		{
			return _hint;
		}
